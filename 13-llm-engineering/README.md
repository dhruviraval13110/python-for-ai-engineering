...
<img src="../assets/13-llm-engineering.svg" alt="Animated LLM Engineering learning map" width="100%">
...
**reliable applications around models: tools, agents, memory, eval, latency and cost**
...
- [Structured Output](01-structured-output.md) — Schemas, validation, retries and deterministic downstream contracts.
- [Tools & Function Calling](02-tools-function-calling.md) — Tool schemas, validation, authorization, failure handling and idempotency.
- [Agents](03-agents.md) — Planning, tool loops, state, termination conditions, permissions and observability.
- [Memory](04-memory.md) — Conversation state, retrieval memory, summaries, privacy boundaries and stale-memory risks.
- [Production LLM Systems](05-production.md) — Latency, cost, caching, rate limits, fallbacks, logging, tracing and evaluation gates.
