# Sql — SQL for Analytics

<img src="../assets/07-sql.svg" alt="Animated SQL for Analytics learning map" width="100%">
...
**relational thinking → querying → joins → windows → modeling → optimization**
...
- [Querying Fundamentals](01-querying.md) — SELECT, WHERE, ORDER BY, DISTINCT, CASE, NULL semantics and aggregations.
- [Joins](02-joins.md) — INNER/LEFT/RIGHT/FULL concepts, cardinality, duplicate multiplication and anti-joins.
- [CTEs & Window Functions](03-ctes-windows.md) — CTEs, ROW_NUMBER, RANK, LAG/LEAD, running totals and cohort patterns.
- [Database Design](04-database-design.md) — Keys, normalization, constraints, indexes and analytical schema choices.
- [Query Performance](05-query-performance.md) — Indexes, query plans, selectivity, avoiding accidental scans and reproducible benchmarking.
