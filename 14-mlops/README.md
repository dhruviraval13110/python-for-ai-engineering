...
<img src="../assets/14-mlops.svg" alt="Animated MLOps learning map" width="100%">
...
**reproducible data → training → tracking → registry → service → monitoring**
...
- [Reproducibility](01-reproducibility.md) — Environment locking, seeds, data lineage, configs, artifacts and deterministic assumptions.
- [Experiment Tracking](02-experiment-tracking.md) — Runs, parameters, metrics, artifacts, baselines and comparison discipline.
- [Model Registry](03-model-registry.md) — Model versions, metadata, promotion rules, rollback and approval gates.
- [ML Testing](04-testing.md) — Unit, data, schema, integration, model behavior and regression tests.
- [Monitoring](05-monitoring.md) — Service health, data drift, concept drift, performance decay and alert design.
