...
<img src="../assets/15-deployment.svg" alt="Animated Deployment learning map" width="100%">
...
**package → API → container → cloud/runtime → observe → rollback**
...
- [API Serving](01-api-serving.md) — Request schemas, validation, prediction endpoints, health checks and error contracts.
- [Docker](02-docker.md) — Images, layers, reproducible builds, non-root execution, environment variables and healthchecks.
- [CI/CD](03-ci-cd.md) — Tests, linting, build verification, artifact promotion and deployment gates.
- [Production Readiness](04-production-readiness.md) — Security, performance, observability, rollback, capacity and documentation.
