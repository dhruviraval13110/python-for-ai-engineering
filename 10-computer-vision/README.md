...
<img src="../assets/10-computer-vision.svg" alt="Animated Computer Vision learning map" width="100%">
...
**images → preprocessing → CNNs → transfer learning → detection → segmentation → OCR**
...
- [Image Foundations](01-image-foundations.md) — Pixels, channels, tensors, normalization, resizing and augmentation.
- [Image Classification](02-classification.md) — CNN pipeline, datasets, metrics, imbalance and visual error analysis.
- [Transfer Learning](03-transfer-learning.md) — Frozen backbones, fine-tuning, domain shift and evaluation.
- [Detection & Segmentation](04-detection-segmentation.md) — Boxes, masks, IoU, precision/recall and task-specific failure modes.
- [OCR & Image Similarity](05-ocr-similarity.md) — Text extraction, preprocessing, embeddings, nearest-neighbor retrieval and evaluation.
