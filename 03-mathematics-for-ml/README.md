# Mathematics For Ml — Mathematics for Machine Learning

<img src="../assets/03-mathematics-for-ml.svg" alt="Animated Mathematics for Machine Learning learning map" width="100%">
...
**linear algebra + calculus + probability + optimization, always connected to models**
...
- [Linear Algebra](01-linear-algebra.md) — Vectors, matrices, dot products, norms, projections, eigen concepts and ML applications.
- [Calculus](02-calculus.md) — Functions, derivatives, partial derivatives, gradients, chain rule and backpropagation intuition.
- [Probability](03-probability.md) — Random variables, distributions, conditional probability, Bayes theorem and expectation.
- [Optimization](04-optimization.md) — Objective functions, gradients, gradient descent, learning rates, convexity intuition and regularization.
