...
<img src="../assets/04-statistics.svg" alt="Animated Statistics learning map" width="100%">
...
**descriptive statistics → sampling → inference → correlation → uncertainty → experiments**
...
- [Descriptive Statistics](01-descriptive.md) — Mean, median, variance, quantiles, distributions, outliers and robust summaries.
- [Statistical Inference](02-inference.md) — Samples, estimators, confidence intervals, hypothesis tests, p-values and practical significance.
- [Experiments & A/B Testing](03-experiments.md) — Hypotheses, randomization, metrics, power intuition, confounders and decision rules.
