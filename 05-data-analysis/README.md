...
<img src="../assets/05-data-analysis.svg" alt="Animated Data Analysis learning map" width="100%">
...
**question → data → quality → EDA → insight → recommendation**
...
- [Problem Framing](01-problem-framing.md) — Turn vague business questions into measurable analytical questions and success criteria.
- [Data Cleaning](02-data-cleaning.md) — Missingness, duplicates, types, outliers, inconsistent categories and validation.
- [Exploratory Data Analysis](03-eda.md) — Univariate, bivariate and multivariate analysis with question-first investigation.
- [Insight to Decision](04-insight-to-decision.md) — Communicating evidence, uncertainty, recommendations and limitations.
