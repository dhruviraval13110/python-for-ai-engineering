...
## What it solves
Principal Component Analysis is useful when the goal is to **rotate data into directions of maximal variance**.
...
**Core formulation:** `maximize variance / minimize reconstruction error`

**Training objective / evaluation idea:** `explained variance`
