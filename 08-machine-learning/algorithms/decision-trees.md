...
## What it solves
Decision Trees is useful when the goal is to **recursively partition feature space with decision rules**.
...
**Core formulation:** `choose split maximizing impurity reduction`

**Training objective / evaluation idea:** `Gini / entropy / MSE`
