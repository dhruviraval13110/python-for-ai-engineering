...
## What it solves
Naive Bayes is useful when the goal is to **combine likelihoods under a conditional-independence assumption**.
...
**Core formulation:** `P(y|x) ∝ P(y)∏P(x_i|y)`

**Training objective / evaluation idea:** `negative log likelihood`
