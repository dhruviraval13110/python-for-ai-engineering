...
## What it solves
K-Means is useful when the goal is to **partition points into k centroid-based clusters**.
...
**Core formulation:** `argmin Σ||x_i-μ_{c_i}||²`

**Training objective / evaluation idea:** `within-cluster SSE`
