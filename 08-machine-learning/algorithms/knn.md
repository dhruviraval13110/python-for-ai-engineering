...
## What it solves
K-Nearest Neighbors is useful when the goal is to **predict from nearby training examples**.
...
**Core formulation:** `ŷ = aggregate of neighbors`

**Training objective / evaluation idea:** `distance-aware error`
