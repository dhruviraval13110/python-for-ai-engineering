...
## What it solves
Support Vector Machine is useful when the goal is to **find a margin that separates classes or fits a tube for regression**.
...
**Core formulation:** `minimize margin objective + slack`

**Training objective / evaluation idea:** `hinge / epsilon-insensitive loss`
