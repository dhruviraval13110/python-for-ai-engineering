...
## What it solves
Linear Regression is useful when the goal is to **predict a continuous target as a weighted combination of features**.
...
**Core formulation:** `y_hat = Xw + b`

**Training objective / evaluation idea:** `squared error`
