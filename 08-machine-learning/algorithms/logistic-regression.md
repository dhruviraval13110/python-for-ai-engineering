...
## What it solves
Logistic Regression is useful when the goal is to **predict class probability with a logistic link**.
...
**Core formulation:** `p(y=1|x)=sigmoid(wᵀx+b)`

**Training objective / evaluation idea:** `log loss`
