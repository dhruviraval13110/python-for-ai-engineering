...
## What it solves
Random Forest is useful when the goal is to **average many randomized decision trees to reduce variance**.
...
**Core formulation:** `ŷ = aggregate_t tree_t(x)`

**Training objective / evaluation idea:** `task metric`
