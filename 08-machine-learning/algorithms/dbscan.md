...
## What it solves
DBSCAN is useful when the goal is to **find dense regions and mark sparse points as noise**.
...
**Core formulation:** `density connectivity via ε and min_samples`

**Training objective / evaluation idea:** `cluster stability / domain metric`
